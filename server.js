...
const textToSpeech = require('@google-cloud/text-to-speech'); //Cloud Text-to-Speech API
const {TranslationServiceClient} = require('@google-cloud/translate'); //Cloud Translation API
...
//Gemini
const apiKey = "AIzaSyBE5AM_nZat5Ox2uQSaqlbee6WuE7euzLs" 
const genAI = new GoogleGenerativeAI(apiKey);

// connects to translation api service via google account
const translationClient = new TranslationServiceClient({
    keyFilename: '../key.json' // Path to your API key file
});

// connects to text-to-speech api service via google account
const client = new textToSpeech.TextToSpeechClient({ //
  keyFilename: '../key.json' // Path to your API key file
});

const projectId = 'airabicproject';
