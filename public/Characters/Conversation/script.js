...
function initiateConversation(initialMessage) {
    fetch('https://airabic.site/get-response', {
        method: 'POST',
        headers: {
...
function submitHowDoISay() {
    ...
    if (input) {
        ...
        fetch('https://airabic.site/how-do-I-say', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    words.forEach(word => {
        ...
        if (cleanWord.length > 0) { // Only create a span if the word is not empty after removing punctuation
            ...
            wordSpan.onmouseover = function() {
                fetch('https://airabic.site//translate', {
                    method: 'POST',
...
function submitQuestion() {
    ...
    fetch('https://airabic.site/ask-gemini', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function aiSpeak(text) {
    fetch('https://airabic.site/synthesize', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
